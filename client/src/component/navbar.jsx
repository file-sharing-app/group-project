  ...
  return (
    <>
      <nav className="bg-white shadow fixed z-10 mx-auto inset-x-0 top-0 flex justify-between items-center">
        <Link
          to={"/"}
          className="font-extrabold m-3 uppercase inline-flex hover:text-teal-700 transition-all duration-500"
        >
          <svg
        ...
        >
          <button
            onClick={logout}
            className="mx-0 sm:mx-10 my-2 border-b-2 border-transparent hover:border-teal-600 hover:text-teal-700 transition-all duration-500 py-1 sm:p-0"
          >
            Logout
          </button>
        </div>
